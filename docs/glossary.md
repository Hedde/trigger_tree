...
| Scan | A conservative record of an explicit documentation search target; search output is never a read. |
...
| Injected / always loaded | Context loaded without a Read event, such as `CLAUDE.md`, rules, and imports; classified, not guessed. |
